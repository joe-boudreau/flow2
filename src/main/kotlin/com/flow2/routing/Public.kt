        ...
        get("/projects") {
            val projects = listOf(
                mapOf(
                    ...
                    "description" to "Price and inventory tracking service for any online store. User can receive push " +
                            "notifications for sales and other product events. Available as a web extension and mobile app too."
                ),
                mapOf(
                    "title" to "Othello World",
                    "year" to "2026",
                    "link" to "/othelloworld/",
                    "description" to "Web-based Othello game. Allows the player to choose between different algorithms."
                ),
                mapOf(
                    "title" to "Daily Quordle Solver",
                    "year" to "2025",
                    "link" to "/daily-quordle-solver.html",
                    "description" to "Serverless automation that solves Merriam-Webster's daily Quordle puzzle using " +
                            "Selenium and the OpenAI API."
                ),
                mapOf(
                    "title" to "SumarAI",
                    "year" to "2024",
                    "link" to "https://chromewebstore.google.com/detail/sumarai/mkkjeikhldaeolgmcclafecidaggcacc",
                    "description" to "Chrome extension that enables one-click article summaries using the OpenAI API. " +
                            "Uses Mozilla's readability library for text extraction."
                ),
                mapOf(
                    "title" to "Chess Engine",
                    "year" to "2018",
                    "link" to "https://github.com/joe-boudreau/chess-engine",
                    "description" to "A Java based chess engine implementing minimax search with alpha-beta tree " +
                            "pruning, transposition tables, iterative deepening, and heuristic board evaluations."
                ),
            )
