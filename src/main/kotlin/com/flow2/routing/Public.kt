            ...
            val projects = listOf(
                mapOf(
                    ...
                    "description" to "Serverless automation that solves Merriam-Webster's daily Quordle puzzle using " +
                            "Selenium and the OpenAI API. <br/> If it wins, art is generated by Dall-E using the four " +
                            "words from the puzzle. The HTML output is updated daily with the results."
                ),
                mapOf(
                    "title" to "SumarAI",
                    "year" to "2024",
                ...
                mapOf(
                    ...
                    "description" to "A Java based chess engine implementing minimax search with alpha-beta tree " +
                            "pruning, transposition tables, iterative deepening, and heuristic board evaluations. <br/> " +
